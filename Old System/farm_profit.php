            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col" style="padding-top:20px;">
                                    ...
                                    <button class="btn btn-danger">
                                        <a href="farm_profitPDF.php?from_date=<?php echo htmlspecialchars($from_date); ?>&to_date=<?php echo htmlspecialchars($to_date); ?>" class="text-light">Export PDF</a>
                                    </button>
                                </div>
                            </div>
                        </form>
                        ...
                        <table class="table table-bordered border-dark" style="margin-top: -50px;">
                            <thead>
                                <tr>
                        ...
                        <table class="table table-bordered border-dark">
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="4" style="padding-left: 200px;">Total Birds Stock Value</td>
                                    <td style="text-align: right; padding-right: 20px;"><?php echo number_format($stocksDataCategorized['total_bird_stock_amount'],  2); ?></td>
                                </tr>
                                <tr>
                                    <td colspan="4" style="padding-left: 200px;">Total Medicine Stock Value</td>
                                    <td style="text-align: right; padding-right: 20px;"><?php echo number_format($stocksDataCategorized['total_medicine_stock_amount'], 2); ?></td>
                                </tr>
                                <tr>
                                    <td colspan="4" style="padding-left: 200px;">Total Feeds Stock Value</td>
                                    <td style="text-align: right; padding-right: 20px;"><?php echo number_format($stocksDataCategorized['total_feed_stock_amount'], 2); ?></td>
                                </tr>
                                <tr>
